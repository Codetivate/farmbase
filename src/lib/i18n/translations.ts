...
export const th: Translations = {
  ...
  guide: {
    ...
    startSeedsDesc: '1. นับ Day 1: ระยะอนุบาล 1 เดือนแรก (ตัดไหลชำราก) จะไม่ถูกนับ เราจะเริ่มนับ "Day 1" ก็ต่อเมื่อย้ายกล้าที่แข็งแรงแล้วมาเสียบลงรางปลูกหลัก (Main Rack) เท่านั้น 2. จัดแสง: เปิด LED Blue 90 + Red 250 + Far-red 50 µmol/m²/s (Ries 2024) 3. ฟีดปุ๋ย: สูตร Yamazaki คุมโซเดียมน้ำ (Giannothanasis 2024) 4. เป่าลม: 0.3-0.5 m/s ท่อ PE (Zhang & Kacira 2016)',
    transplantSeedlings: 'การกระตุ้นตาดอก (Flower Induction)',
    transplantSeedlingsDesc: 'ไม่ต้องรอหน้าหนาว! 1. อุณหภูมิห้อง: คุมกลางวัน 20-24°C กลางคืน 10-14°C (อุณหภูมิต่างกันช่วยให้ผลใหญ่และหวานจัด) 2. Crown-cooling: เปิดน้ำเย็น 20°C หล่อเฉพาะโคนต้น 3. แสง: ให้แสงวันสั้น 8 ชม. ทำต่อเนื่อง 22 วัน จะบังคับให้ต้นแทงช่อดอกได้สมบูรณ์แบบแม้อากาศภายนอกจะร้อนถึง 30°C (Hidaka 2017)',
    ...
    harvestVegetableDesc: '1. วัฏจักร 3 คลื่นใหญ่: 1 ฤดูกาล (8-10 เดือน) แบ่งเก็บได้ 3 รอบใหญ่ สลับพักต้นรอบละ 1 เดือน 2. ลบช่องโหว่ (Phasing): สลับ "ปลูกเหลื่อมเวลา" (แร็คซ้าย Day 1 / แร็คขวา Day 45) จะมีผลผลิตออกทุกวัน 3. มาตรฐานตัดผล (Robot/คน): เก็บตอนผิวแดง 80-90% "ห้ามจับเนื้อผลเด็ดขาด!" ให้จับที่ก้านแล้วตัดเหนือขั้ว 1-2 ซม. (ยืดอายุ Shelf-life ได้ 30% ลดราสะสม Kader 1999) เวียนซ้ำทุก 3-4 วัน ผลผลิตเฉลี่ย:',
...
export const en: Translations = {
  ...
  guide: {
    ...
    startSeedsDesc: '1. Tracking Day 1: The first 1-month nursery phase (rooting) is NOT counted. Day 1 officially starts when strong seedlings are transplanted into the Main Production Rack. 2. Lighting: Blue 90 + Red 250 + Far-red 50 µmol/m²/s (Ries 2024). 3. Nutrients: Yamazaki formula (monitor Na⁺ < 2 mmol/L). 4. Airflow: 0.3-0.5 m/s via PE ducts (Zhang 2016).',
    transplantSeedlings: 'Flower Induction',
    transplantSeedlingsDesc: '1. Room Temp: Maintain Diurnal Temperature Difference (DIF) with 20-24°C Day / 10-14°C Night to maximize fruit size & Brix. 2. Crown-cooling: Cool only the crown to 20°C. 3. Light: Set short-day (8h) for 22 days. Works even at 30°C ambient — critical for tropical forcing culture (Hidaka 2017).',
    ...
    harvestVegetableDesc: '1. Production Flushes: Over 8-10 months, expect 3 major harvest flushes with 1-month resting gaps. 2. Staggered Planting (Phasing): Eliminate resting downtime by offset planting (Left rack Day 1 / Right rack Day 45). 3. Harvest Standard (Robot/Human): Pick at 80-90% redness. NEVER touch the fruit body; hold the peduncle and cut 1-2 cm above the calyx to extend shelf-life by 30% and prevent fungal bruising (Kader 1999). Pick every 3-4 days. Expected Yield:',
    postHarvest: 'Post-Harvest Care',
    postHarvestDesc: 'Fruits: Pre-cool to 1-4°C within 1h. Store in MAP bags (reduce O₂, elevate CO₂ 15-20%) for 7-10 day shelf life (Priyadarshi 2024). Mother plants: Max lifespan 8-10 months. When runners emerge, propagate via Tray-plant method (yields 30-50 clones/mother, eliminating seedling costs for the next cycle). Nursery setup: Excise runners with 2-4 leaves and place in trays on the bottom rack of the 12 sqm room (20-25°C). Mist frequently to maintain 90-100% RH until roots establish. Then move to a 2-5°C cold room (crown-cooling) to re-induce flowers.',
  },
  environment: {
