...
export const th: Translations = {
  ...
  guide: {
    ...
    harvestVegetableDesc: '1. วัฏจักร 3 คลื่นใหญ่ (Flushes): 1 ฤดูกาล (8-10 เดือน) จะเก็บเกี่ยวได้ 3 รอบใหญ่ มีช่วงพักต้นรอบละ 1 เดือน 2. ลบช่องโหว่ด้วย Phasing: ให้ใช้ระบบ "ปลูกเหลื่อมเวลา" เช่น แร็คซ้ายปลูก Day 1 / แร็คขวารอปลูก Day 45 หุ่นยนต์จะมีให้เก็บทุกวันตลอดปี 3. ตัดด้วย YOLOv8: แยกเก็บตอนแดง 90% ซ้ำทุก 3-4 วัน ผลผลิตเฉลี่ย:',
...
export const en: Translations = {
  ...
  guide: {
    ...
    harvestVegetableDesc: '1. Production Flushes: Over 8-10 months, expect 3 major harvest flushes with 1-month resting gaps. 2. Staggered Planting (Phasing): Eliminate resting downtime by offsetting planting dates. E.g., transplant Left rack on Day 1, and Right rack on Day 45. The robot will harvest continuously year-round. 3. AI Harvest: YOLOv8 picks at 90% redness every 3-4 days. Expected Yield:',
