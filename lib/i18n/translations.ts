...
export const th: Translations = {
  ...
  guide: {
    ...
    startSeedsDesc: 'นำต้นไหลปลอดโรคปลูกลงวัสดุปลูก คุม DLI ที่ 10 mol/m²/d ปรับสูตรปุ๋ย N/K=2.2 เพื่อขยายทรงพุ่มใบตาม NY-Formula (Yu 2023)',
    transplantSeedlings: 'การกระตุ้นตาดอก (Flower Induction)',
    transplantSeedlingsDesc: 'ใช้เทคนิค Crown-cooling 20°C ร่วมกับวันสั้น (8 ชม.) นาน 22 วัน (Hidaka 2017) เดินท่อน้ำเย็นที่รากลดอุณหภูมิ 2°C (Naphrom 2025)',
    optimizeEnvironment: 'ระยะออกดอกและติดผล (Flowering & Fruiting)',
    optimizeEnvironmentDesc: 'ควบคุม CO₂ 800-1000 ppm โดยเลื่อนเวลาเปิดช่องลม (Wada 2010) ปรับ EC 2.0-4.0 dS/m (AJCS 2025) ปล่อยไรนักล่า Miyako กันแมลง (Kim 2022)',
    headFormation: 'เพิ่มความหวาน (Brix Boosting)',
    headFormationDesc: 'ปรับสัดส่วนไฟ LED แดง:น้ำเงิน เป็น 6:1 เพื่ออัดความหวาน (Brix) ปรับปุ๋ย N/K=1.7. เปิดแสง UV-B ป้องกันโรคราแป้งโดยลดเคมี',
    harvestVegetableDesc: 'ตัดผลอย่างระมัดระวัง (Zero-bruise) เข้าสู่รอบเก็บเกี่ยวแรกวันที่ 85-90 และจะเก็บเกี่ยวซ้ำได้ทุกๆ 30-40 วันตลอดช่วง 6-8 เดือน ผลผลิตที่คาดหวัง:',
    postHarvest: 'ดูแลหลังเก็บเกี่ยว (Post-Harvest Care)',
    postHarvestDesc: 'ไม่ต้องถอนต้นทิ้งเมื่อเก็บเกี่ยวเสร็จ! ตัดแต่งใบแก่หรือใบเสียออก ให้ปุ๋ยสูตรฟื้นฟู (N/K=1.5) และปล่อยให้ต้นพัก 1-2 สัปดาห์ ต้นจะเริ่มแทงตาดอกชุดใหม่และให้ผลผลิตต่อเนื่อง',
  },
  environment: {
  ...
  howItWorks: {
    ...
    step2Title: "2. ออกแบบแปลนพาราเมตริก",
...
export const en: Translations = {
  ...
  guide: {
    ...
    startSeedsDesc: 'Plant virus-free runners into growing media. Control DLI at 10 mol/m²/d. Set nutrient formula N/K=2.2 to maximize leaf canopy per NY-Formula (Yu 2023).',
    transplantSeedlings: 'Flower Induction',
    transplantSeedlingsDesc: 'Apply Crown-cooling at 20°C + short-day (8h) for 22 days (Hidaka 2017). Install cold-water root-zone pipes to reduce temp by 2°C in tropical climates (Naphrom 2025).',
    optimizeEnvironment: 'Flowering & Fruiting',
    optimizeEnvironmentDesc: 'Maintain CO₂ at 800-1000 ppm by delaying morning ventilation (Wada 2010). Set EC to 2.0-4.0 dS/m (AJCS 2025). Release Miyako predatory mites for spider mite control (Kim 2022).',
    headFormation: 'Brix Boosting',
    headFormationDesc: 'Shift LED spectrum to Red:Blue 6:1 ratio to maximize sweetness. Adjust nutrient N/K to 1.7. Enable UV-B lighting to prevent powdery mildew without chemicals.',
    harvestVegetableDesc: 'Pick carefully with Zero-bruise handling. First harvest at Day 85-90. Repeat harvest every 30-40 days for 6-8 months in closed systems. Expected yield:',
    postHarvest: 'Post-Harvest Care',
    postHarvestDesc: 'Do not uproot! Prune old/damaged leaves. Apply a recovery nutrient formula (N/K=1.5) and allow a 1-2 week rest period to induce the next flush of flowers for continuous harvesting.',
  },
  environment: {
  ...
  howItWorks: {
    ...
    step2Title: "2. Parametric Design Lab",
    step2Desc: "Generate 3D structural blueprints based on target yields.",
