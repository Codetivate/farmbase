...
export const th: Translations = {
  ...
  guide: {
    ...
    harvestVegetableDesc: '1. วัฏจักร 3 คลื่นใหญ่ (Flushes): 1 ฤดูกาล (8-10 เดือน) จะเก็บเกี่ยวได้ 3 รอบใหญ่ โดยมีช่วงพักต้นรอบละ 1 เดือน 2. ลบช่องโหว่ด้วย Phasing: ไม่อยากขาดรายได้ช่วงพักต้น ให้ใช้ระบบ "ปลูกเหลื่อมเวลา" เช่น นับ Day 1 เมื่อนำกล้าชำรากแล้วลงรางปลูก (แร็คซ้ายปลูก Day 1 / แร็คขวารอปลูก Day 45) หุ่นยนต์จะเวียนเก็บได้มีรายได้ทุกวันตลอดปี 3. การตัด (YOLOv8): แยกเก็บตอนแดง 90% และเวียนซ้ำทุก 3-4 วัน (ตั้งเป้า 8.5 กก./ตร.ม./ปี Takahashi 2024)',
...
export const en: Translations = {
  ...
  guide: {
    ...
    harvestVegetableDesc: '1. Production Flushes: Over 8-10 months, expect 3 major harvest flushes with a 1-month resting gap in between. 2. Staggered Planting (Phasing): To eliminate the resting downtime, offset planting dates. E.g., count Day 1 when transplanting rooted seedlings to gutters (Left rack Day 1 / Right rack Day 45). The robot will harvest continuously year-round. 3. AI Harvest: YOLOv8 picks at 90% redness every 3-4 days. Yield: 8.5 kg/m²/yr (Takahashi 2024).',
